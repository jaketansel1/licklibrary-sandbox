...
<template>
  <div class="relative shrink-0">
    ...
    <!-- Glass card -->
    <div
      class="relative rounded-xl p-12 max-w-3xl border-b-2 border-brand"
      style="background: linear-gradient(160deg, rgba(255,255,255,0.12) 0%, rgba(255,255,255,0.06) 100%); backdrop-filter: blur(5px); border-top: 1.5px solid transparent; border-left: 1px solid rgba(255,255,255,0.1); border-right: 1px solid rgba(255,255,255,0.1); border-image: linear-gradient(to right, transparent, rgba(238,114,103,0.7) 20%, rgba(238,114,103,0.7) 80%, transparent) 1"
    >
      <div class="mb-6">
      ...
      <div v-if="currentStep === 1" class="flex items-center gap-3 flex-wrap">
        <button
          v-for="option in [
            ...
            { label: 'Help me find get started', value: 'exploring' }
          ]"
          :key="option.value"
